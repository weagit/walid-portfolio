...
const externalLinks = [
  { name: "LinkedIn", href: profile.contact.linkedin, icon: "linkedin" as const },
  { name: "GitHub", href: profile.contact.github, icon: "github" as const },
];
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <motion.div
        initial={{ opacity: 0, y: 8 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: delay + externalLinks.length * 0.08 }}
      >
        <MailButton />
      </motion.div>
    </div>
